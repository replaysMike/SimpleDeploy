#define MyAppName "SimpleDeploy Agent"
#define MyAppVersion "0.0"
#define MyAppPublisher "SimpleDeploy"
#define MyAppURL "https://github.com/replaysMike/SimpleDeploy/"
#define MyAppExeName "SimpleDeploy.exe"

[Setup]
AppId={{976695b9-e363-4bdf-a8e2-04a9c6f6a8c1}
AppName={#MyAppName}
...
LicenseFile=..\LICENSE
OutputDir=.\
OutputBaseFilename=SimpleDeployAgentSetup-winx64-{#MyAppVersion}
SetupIconFile=.\icon128x128.ico
Compression=lzma
...
[Run]
Filename: https://localhost:5001; Description: "{cm:LaunchProgram,{#StringChange(MyAppName, '&', '&&')}}"; Flags: postinstall shellexec skipifsilent runhidden
...
begin
  ...
  begin
    ...
    begin
      Log('Running SimpleDeploy in console');
      WizardForm.StatusLabel.Caption := CustomMessage('StartingApp');
      WizardForm.StatusLabel.Show();
